...
+ (XHLoadingNavigationItemTitleView *)initNavigationItemTitleView {
    ...
    [loadingNavigationItemTitleView setTitle:@""];
...
- (TYDotIndicatorView *)darkCircleDot {
    TYDotIndicatorView *darkCircleDot = [[TYDotIndicatorView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - titleLabelHeight / 2.0, CGRectGetWidth(self.titleLabel.frame), CGRectGetHeight(self.bounds) - titleLabelHeight) dotStyle:TYDotIndicatorViewStyleCircle dotColor:self.titleColor dotSize:CGSizeMake(8, 8)];
